...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://car-booking.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).then(api.getGamesForUser).then(ui.getGameSuccess).catch(ui.getGameFailure).catch(ui.signInFailure);
	};
	...
	var onCreateCar = function onCreateCar(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target
	  // debugger
	  );api.createCar(data).then(ui.createCarSuccess).catch(ui.createCarfailure);
	};
	var onGetAllCars = function onGetAllCars(event) {
	  event.preventDefault
	  // const data = getFormFields(event.target)
	  ();api.getAllCars().then(ui.getAllCarsSuccess).catch(ui.getAllCarsFailure);
	};
	var onUpdateCar = function onUpdateCar(event) {
	  event.preventDefault();
	  console.log('is handler working');
	  var data = getFormFields(event.target);
	  var id = $(event.target).parent().parent().attr('data-id');
	  console.log(id, data);
	  api.updateCarInfo(id, data).then(ui.onUpdateCarSuccess).catch(ui.onUpdateCarfailure);
	};

	var onRemoveCar = function onRemoveCar(event) {
	  event.preventDefault();
	  console.log(event);
	  var id = $(event.target).parent().parent().attr('data-id');
	  console.log('this is what we need');
	  console.log(id);
	  api.removeCar(id).then(ui.removeCarSuccess).catch(ui.removeCarFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createCar = function createCar(data) {
	  return $.ajax({
	...
	var updateCarInfo = function updateCarInfo(id, data) {
	...
	var removeCar = function removeCar(data) {
	  return $.ajax({
	    ...
	    // this will run if the DELETE request is successful
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// const store = require('../store')
	var showCarsTemplate = __webpack_require__(13);
	var showSingleCarTemplate = __webpack_require__(33);
	...
	var createCarSuccess = function createCarSuccess(data) {
	  // $('.empfor', 'input[type="text"]').empty()
	  console.log(data);
	  $('#error').hide();
	  $('#succmsg').text('your car is now added on the list');
	  $('#crtnewcar').show();
	  var showsinglecarHtml = showSingleCarTemplate({ car: data.car }
	  // const showcarsHtml = showCarsTemplate({ cars: data.car })
	  );$('#alcr').append(showsinglecarHtml);
	  console.log('create a car done');
	};

	var createCarFailure = function createCarFailure(error) {
	  $('#success').hide();
	  $('#error').show();
	  $('#errmsg').text('input all the field');
	  console.log(error);
	};
	var getAllCarsSuccess = function getAllCarsSuccess(data) {
	  $('.bleh').empty();
	  if (data.cars.length === 0) {
	    ...
	    console.log(data
	    // $('.bleh').empty()
	    );var showcarsHtml = showCarsTemplate({ cars: data.cars });
	...
	var getAllCarsFailure = function getAllCarsFailure(error) {
	  console.log(error);
	};
	var onUpdateCarSuccess = function onUpdateCarSuccess(data) {
	  console.log(data);
	  $('#success').show();
	  $('#error').hide();
	  $('#succmsg').text('your repair has been changed');
	};
	var onUpdateCarFailure = function onUpdateCarFailure(error) {
	  console.error(error);
	  $('#success').hide();
	  $('#error').show();
	...
	var removeCarSuccess = function removeCarSuccess(data) {
	  $('#sign-in').hide();
	  $('#sign-up').hide();
	  $('#change-password').hide();
	  $('#success').show();
	...
	var removeCarFailure = function removeCarFailure(error) {
	  console.error(error);
	};
	module.exports = {
	  ...
	  createCarSuccess: createCarSuccess,
	  createCarFailure: createCarFailure,
	  getAllCarsSuccess: getAllCarsSuccess,
	  getAllCarsFailure: getAllCarsFailure,
	  onUpdateCarSuccess: onUpdateCarSuccess,
	  onUpdateCarFailure: onUpdateCarFailure,
	  removeCarSuccess: removeCarSuccess,
	  removeCarFailure: removeCarFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"bleh\">\n<!--we are using data id and not id -->\n<ul id='tog' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <li><small>carId:"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</small></li>\n  <li><small>Model:"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.model : stack1), depth0))
	    + "</small></li>\n  <li><small>Color-of-car:"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
	    + "</small></li>\n  <li><small>licence-plate-no:"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.lcp : stack1), depth0))
	    + "</small></li>\n  <li><small>Repair-needed:<span class = \"rep\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.repair : stack1), depth0))
	    + "</span></small></li>\n  <li><form class=\"updetail\">\n      <div class=\"form-group\">\n        <label for=\"rpnd\">Change-Needed:</label>\n        <input type=\"text\" name=\"car[repair]\" class=\"form-control\" id=\"rep\">\n      </div>\n          <button class =\"update\" type=\"submit\" class=\"btn btn-info btn-block\">Submit</button>\n  </form></li>\n  <li><button class=\"removebtn\" class=\"btn btn-primary btn-block\">Remove Cars list!</button></li>\n\n</ul>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.cars : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"single\">\n<!--we are using data id and not id -->\n<ul id='tcar' data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <li><small>carId:"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</small></li>\n  <li><small>Model:"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.model : stack1), depth0))
	    + "</small></li>\n  <li><small>Color-of-car:"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.color : stack1), depth0))
	    + "</small></li>\n  <li><small>licence-plate-no:"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.lcp : stack1), depth0))
	    + "</small></li>\n  <li><small>Repair-needed:<span class = \"rep\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.car : depth0)) != null ? stack1.repair : stack1), depth0))
	    + "</span></small></li>\n  <li><form class=\"updetail\">\n      <div class=\"form-group\">\n        <label for=\"rpnd\">Change-Needed:</label>\n        <input type=\"text\" name=\"car[repair]\" class=\"form-control\" id=\"rep\">\n      </div>\n          <button class =\"update\" type=\"submit\" class=\"btn btn-info btn-block\">Submit</button>\n  </form></li>\n  <li><button class=\"removebtn\" class=\"btn btn-primary btn-block\">Remove Cars list!</button></li>\n\n</ul>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "566eeed6966ed912dbeda358c99147be.png";
